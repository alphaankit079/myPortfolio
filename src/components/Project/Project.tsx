          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/alphaankit079/Dragon-Game" target="_blank" rel="noreferrer">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/alphaankit079/Car-Animation" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Car Animation Web Application</h3>
              <p>A visually engaging animated car simulation built using HTML, CSS, and JavaScript. This project mimics a moving car on a dynamic road, featuring rotating wheels, a moving background, and background audio for an immersive experience. </p>
            </div>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/alphaankit079/Tic-Tac-Toe-Game" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/alphaankit079/Leet-Code-Metrics" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>LeetMetric</h3>
              <p>LeetMetric is a clean and responsive web application that visualizes your LeetCode problem-solving progress using circular progress charts and statistical cards. Just enter your LeetCode username and view your submission stats categorized by difficulty — Easy, Medium, and Hard.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>JavaScript</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/alphaankit079/Countdown-Timer" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
            ...
            <div className="body">
              <h3>Contdown Timer</h3>
              <p>A simple and elegant countdown timer that counts down to a specific date and time using HTML, CSS, and JavaScript. The timer also features a smooth progress bar that visually tracks how much time has passed.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>JavaScript</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/alphaankit079/myPortfolio" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
